...
;  Section: 1003
;  Assignment: 3
;  Description: output a series of equations
...
mov rax, qword [qNum6]
imul rax, qword [qNum7]
mov qword [dqAns14], rax

;	dqAns15  = qNum5 * qNum8 

mov rax, qword [qNum5]
imul rax, qword [qNum8]
